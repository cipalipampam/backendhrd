...
async function main() {
  ...
  try {
    ...
    console.log("✅ View 'v_kpi_karyawan_bulanan' created successfully");
  } catch (error) {
    console.error("❌ Failed to create views:", error.message);
    // Don't fail the entire seeding process if views fail
    console.log("⚠️  Continuing without views...");
  }
}
